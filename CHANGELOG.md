...
## [3.0.0](https://github.com/google/adk-python/compare/v2.8.0...v3.0.0) (2026-09-09)


### Highlights

This release introduces robust model fallbacks, native LiveKit support for voice agents, YAML-configured workflows, and compatibility with MCP SDK 2.x, alongside critical performance improvements and key security updates.

* **Models**: Fall back automatically to a secondary model when primary model calls fail to ensure high availability. ([c300b8d](https://github.com/google/adk-python/commit/c300b8ded62b8bc4168cdede4c85bec66d1aa8ee))
* **Integrations**: Deploy real-time voice and telephony agents using the new LiveKit runner. ([f277d91](https://github.com/google/adk-python/commit/f277d9117781fb4e2d8cd2608a1d484c29884e60))
* **Workflows**: Simplify development by defining and loading ADK 2.0 graph workflows directly from YAML configurations. ([2a9461b](https://github.com/google/adk-python/commit/2a9461b1da1c3f7bf732cb37ac43a865f907c6a4))
* **Model Context Protocol (MCP)**: Connect seamlessly to external tools with newly added compatibility for MCP SDK 2.x. ([856acf2](https://github.com/google/adk-python/commit/856acf21e3155d2145f9af0709434dd46843539c))

#### Breaking changes

* **Workflows**: Adjust retry logic to account for nested workflows now retrying automatically when internal nodes fail.
* **GCS Tool**: Update local file paths to fall within your configured root directory to avoid access restriction errors.
* **Workflows**: Anticipate that failed nodes will now rerun upon workflow resume instead of replaying as completed.
* **Sessions**: Update error handling to catch `SessionNotFoundError` when attempting to append to an unrecognized session.
* **MCP**: Migrate custom vendor extensions under `_meta` when using MCP SDK 2.x to prevent undeclared fields from being discarded during validation.
